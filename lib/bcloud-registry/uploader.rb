    ...
    class Uploader
      ...
      def upload_box
        if @interrupted_upload_url
          ...
          @env.ui.info(I18n.t("bcloud_registry.push.continue_upload"))
        else
      ...
      def create_new_box
        ...
        create_box = nil
        message = I18n.t("bcloud_registry.push.ask_box_create",
                         :username => @username,
                         :box_name => @box_name) + " "
        ...
        @env.ui.success(I18n.t("bcloud_registry.push.box_created",
                               :username => @username,
                               :box_name => @box_name))
      end
            ...
            with_error_handling do
              begin
                ...
                if response.code == 201
                  self.clean_stored_upload_url
                  @env.ui.success(I18n.t("bcloud_registry.push.box_file_uploaded"))
                end
