...
describe BcloudPlugins::Registry::AddAuthentication do
  ...
  let(:iso_env) { isolated_environment.create_bcloud_env }
  ...
  describe "#call" do
    ...
    it "appends the access token to the URL of server URLs" do
      token = "asdf1234"
      BcloudPlugins::Registry::Client.new(iso_env, server_url).store_token(token)
