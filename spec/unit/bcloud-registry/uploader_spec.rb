...
describe BcloudPlugins::Registry::Uploader do
    ...
    context "when upload URL expired" do
      it "shows error message" do
        ...
        expect { subject.upload_box }.
            to raise_error(BcloudPlugins::Registry::Errors::BoxUploadExpired)
    ...
    context "when upload initialised with invalid data" do
      it "shows error message" do
        ...
        expect { uploader.upload_box }.
            to raise_error(BcloudPlugins::Registry::Errors::BoxUploadError)
